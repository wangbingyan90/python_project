...
class BaiduIndex:
    ...
    def __init__(self, keywords,area='广州',start_date='2018-09-01', end_date='2018-09-02'):
        '''
            1，关键词分词
            2，地域分词，建立数据表
            3，设置起始时间
        ...
        # self.result['广州']['all'].append('formated_data')
        # self.result['广州']['all'].append('2')
        # print(self.result['广州']['all'][0])
...
if __name__ == '__main__':
    # baidu_index = BaiduIndex(['万达', '2018-08-11', '2018-09-11')
    baidu_index = BaiduIndex('万达','广州,北京' )
